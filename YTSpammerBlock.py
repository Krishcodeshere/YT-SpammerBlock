...
def main():
  ...
  print("\nLoading YT Spammer Block @ " + str(version) + "...")
  ...
  def primaryInstance(miscData):
    ...
    while validMode == False:
      ...
      if scanMode in validModeValues:
        ...
        print(f"\nInvalid choice: {scanMode} - Enter a number")
...
# ====================================================================================================================================================================================================
    ...
    print("-------------------------------------------------------")
    print(f"{S.BRIGHT} 1. {S.R} {S.BRIGHT}{autoSmartColor}Smart Mode{F.R}: Automatically detects multiple spammer techniques{S.R}")
    ...
    if userNotChannelOwner == True and moderator_mode == False:
      print(f" {F.LIGHTRED_EX}*Note: This is not video from your channel, you can only report matched comments") # Based on filterModesAllowedforNonOwners
    elif userNotChannelOwner == True and moderator_mode == True:
